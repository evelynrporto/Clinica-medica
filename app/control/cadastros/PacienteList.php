...
class PacienteList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink(_t('New'), new TAction(['PacienteForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['PacienteView', 'onReload'], ['id'=>'{id}', 'register_state' => 'false']);
        //$action1 = new TDataGridAction(['PacienteForm', 'onEdit'], ['id'=>'{id}', 'register_state' => 'true']);
